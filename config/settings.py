...
SECRET_KEY = env.str("SECRET_KEY", default="django-insecure-#i*&m$0)r0(vlic3jwgi4&1rrwj53mz^cdi-t--o@8@2^gpnks")

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = env.bool("DEBUG", default=True)

ALLOWED_HOSTS = env.list("ALLOWED_HOSTS", default=["localhost", "127.0.0.1","https://dwella-onoa.onrender.com"])
